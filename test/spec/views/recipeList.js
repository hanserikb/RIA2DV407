define(['backbone', 'handlebars', 'recipeListView', 'recipeCollection', 'recipeModel'], function(Backbone, Handlebars, RecipeListView, RecipeCollection, RecipeModel) {

  beforeEach(function() {
    $('body').append('<div id="content"></div>');
    this.dishCollection = new RecipeCollection();
    this.recipeList = new RecipeListView({collection: this.dishCollection});
  });
  ...
  describe('Recipe collection view', function() {
    ...
    describe('when adding a model object', function() {
      ...
      it('should add a entry to the view', function() {
        ...
        this.dishCollection.add(new RecipeModel({name: 'Meatballs', description: 'Mamma Mia, That\'s Some Spicy Meatball', cookingTime: '35 minutes'}));
    ...
    describe('when removing a model object', function() {
      var obj = new RecipeModel({name: 'Meatballs', description: 'Mamma Mia, That\'s Some Spicy Meatball', cookingTime: '35 minutes'});
